                ...
                <tr id="variation-id-{{ $variation->id }}">
                    ...
                    <td>
                        @if ($currentRelatedProduct)
                            {{ ($currentRelatedProduct->front_sale_price) }}VND
                            @if ($currentRelatedProduct->front_sale_price != $currentRelatedProduct->price)
                                <del class="text-danger">{{ ($currentRelatedProduct->price) }}VND</del>
                            @endif
                        @else
                            {{ ($product->front_sale_price) }}VND
                            @if ($product->front_sale_price != $product->price)
                                <del class="text-danger">{{ ($product->price) }}VND</del>
                            @endif
                        @endif
                    </td>
                    <td>
