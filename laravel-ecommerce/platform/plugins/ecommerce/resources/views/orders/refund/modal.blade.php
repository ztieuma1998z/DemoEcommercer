                        ...
                        @if ($product)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span>{{ ($orderProduct->price) }}VND</span>
                                </td>
                ...
                <table class="refund-totals">
                    ...
                    <tr>
                        ...
                        <td class="text-right quantity">
                            <span>{{($order->shipping_amount) }}VND</span>
                        </td>
                    </tr>
                    @if ($order->payment->refunded_amount)
                        <tr>
                            ...
                            <td class="text-right quantity text-no-bold">
                                <span>{{ ($order->payment->refunded_amount) }}VND</span>
                            </td>
                        </tr>
                    @endif
                    <tr>
                        ...
                        <td class="text-right quantity text-no-bold">
                            @if ($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::PENDING)
                                <span>{{ (0) }}VND</span>
                            @else
                                <span>{{ ($order->payment->amount - $order->payment->refunded_amount) }}VND</span>
                            @endif
                        </td>
                    </tr>
                    </tbody>
