<li class="list-group-item">
    ...
    >
    <label for="shipping-method-{{ $shippingKey }}-{{ $shippingOption }}">{{ $shippingItem['name'] }} - @if ($shippingItem['price'] > 0) {{ ($shippingItem['price']) }} @else <strong>{{ __('Free shipping') }}</strong> @endif</label>
</li>
